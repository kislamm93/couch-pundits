...
from app.seed import build_fixtures, build_knockout_fixtures, build_r16_fixtures  # noqa: E402
...
async def seed():
    ...
    fixtures = build_fixtures() + build_knockout_fixtures() + build_r16_fixtures()
