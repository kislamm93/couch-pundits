...
from app.seed import seed_if_empty, seed_knockout_if_missing, seed_r16_if_missing, seed_qf_if_missing, seed_sf_if_missing, seed_final_if_missing
...
async def startup():
    ...
    await seed_final_if_missing(get_db())
